...
class _ConfiguracionScreenState extends State<ConfiguracionScreen> {
  ...
  void _navigateToDetail(String option) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DetailScreen(option: option, notificationsEnabled: notificationsEnabled, darkMode: darkMode),
      ),
    );
  }
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.option) {
      case 'Perfil':
        content = Column(
          children: [
            ...
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: () => _showSnackBar("Cambios guardados para $name"),
      ...
      case 'Notificaciones':
        content = Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () => _showSnackBar("Preferencias de notificaciones actualizadas"),
      ...
      case 'Idioma':
        String selectedLanguage = 'Español'; // Default language
        content = Column(
          children: [

...
Widget _buildBackground() {
  return Container(
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [Color(0xFF6bffb5), Color(0xFFFFFFFF)], // Degradado de verde a blanco
  ...
  Widget _buildLogo() {
    return Column(
      children: [
        Image.asset("assets/images/logo_utea_go.png", width: 100, height: 100), // Logo de UTEA GO
        SizedBox(height: 10),
      ],
    );
  }
  ...
  Widget _buildRegistrationPrompt() {
    return Row(
      ...
      children: [
        Text("¿No tienes una cuenta?", style: TextStyle(color: Colors.black54)),
        TextButton(
          onPressed: () {
            Navigator.push(
              context,

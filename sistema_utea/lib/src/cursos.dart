                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (selectedTime != null) {
                        fechaInicioCtrl.text = selectedTime.format(context);
                      }
                    },
                    child: AbsorbPointer(
                      child: _buildTextField('Fecha Inicio', fechaInicioCtrl),
                    ),
                  ),
                  const SizedBox(height: 8),
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (selectedTime != null) {
                        fechaFinCtrl.text = selectedTime.format(context);
                      }
                    },
                    child: AbsorbPointer(
                      child: _buildTextField('Fecha Fin', fechaFinCtrl),
                    ),
                  ),
                  const SizedBox(height: 8),

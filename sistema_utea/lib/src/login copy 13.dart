...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  bool _isLoggingIn = false; // Control para evitar login doble
  ...
  Future<void> _login() async {
    if (_isLoggingIn || !_formKey.currentState!.validate()) return; // evita llamada doble
  ...
  Future<void> _performLogin() async {
    ...
    final url = Uri.parse("http://127.0.0.1/ProyectoColegio/Colegio/main.php");
